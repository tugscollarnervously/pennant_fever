...
log_filename = f"/Users/sputnik69/Documents/_CODE/_pennant_race/league_files/_fictional_generator_log_{timestamp}.txt"
...
corporate_names_df = pd.read_excel('/Users/sputnik69/Documents/_CODE/_pennant_race/CorpoNames/corporate_names.xlsx')
league_name_sources_df = pd.read_excel('/Users/sputnik69/Documents/_CODE/_pennant_race/CorpoNames/league_name_sources.xlsx')
...
first_names_df = pd.read_excel('/Users/sputnik69/Documents/_CODE/_pennant_race/data/first_names_weighted_v2.xlsx')
surnames_df = pd.read_excel('/Users/sputnik69/Documents/_CODE/_pennant_race/data/surnames_weighted_v4.xlsx')
high_school_df = pd.read_excel('/Users/sputnik69/Documents/_CODE/_pennant_race/data/schools_register.xlsx', sheet_name='HS')
college_df = pd.read_excel('/Users/sputnik69/Documents/_CODE/_pennant_race/data/schools_register.xlsx', sheet_name='COL')

# Load city data from CITY sheet
city_data = pd.read_excel('/Users/sputnik69/Documents/_CODE/_pennant_race/data/team_generation.xlsx', sheet_name='CITY')

# Load nickname data from NICKNAMES sheet
nickname_data = pd.read_excel('/Users/sputnik69/Documents/_CODE/_pennant_race/data/team_generation.xlsx', sheet_name='NICKNAMES')
...
class BatterProfile:
    ...
    def generate_splits(self):
        ...
        if self.bats == "L":
            # Small chance of reverse splits (higher splits against same-handedness)
            if np.random.rand() < 0.1:  # 10% chance of reverse splits
                splits_L = self.skewed_random(floor, ceiling, skew="high")
            else:
                splits_L = self.skewed_random(floor, ceiling, skew="low")
            splits_R = self.skewed_random(floor, ceiling, skew="high")  # Opposite-handedness will be higher
        
        elif self.bats == "R":
            # Small chance of reverse splits (higher splits against same-handedness)
            if np.random.rand() < 0.1:  # 10% chance of reverse splits
                splits_R = self.skewed_random(floor, ceiling, skew="high")
            else:
                splits_R = self.skewed_random(floor, ceiling, skew="low")
            splits_L = self.skewed_random(floor, ceiling, skew="high")  # Opposite-handedness will be higher
        
        elif self.bats == "B":  # Switch-hitters
            # Switch hitters will have more neutral splits, but skew slightly toward higher values for opposite-handedness
            splits_L = self.skewed_random(floor, ceiling, skew="neutral")
            splits_R = self.skewed_random(floor, ceiling, skew="neutral")

        # Special case for platoon players
        if self.archetype.name == "platoon":
            # Platoon players should be stronger against opposite-handedness
            if self.bats == "L":
...
class ScoutingReport:
    ...
    def load_templates(self):
        ...
        with open('/Users/sputnik69/Documents/_CODE/_pennant_race/scouting_reports.json', 'r') as f:
            return json.load(f)
    ...
    def generate_report(self):
        ...
        final_report = final_report.replace("\u2019", "'")  # Replace curly apostrophes with straight ones
        return final_report
...
msa_data = pd.read_excel('/Users/sputnik69/Documents/_CODE/_pennant_race/data/team_generation.xlsx')
...
msa_data = pd.read_excel('/Users/sputnik69/Documents/_CODE/_pennant_race/data/team_generation.xlsx', sheet_name='CITY')
...
class League:
    ...
    def save_teams_to_json(self):
        ...
        folder_path = '/Users/sputnik69/Documents/_CODE/_pennant_race/league_files'
    ...
    def print_teams_and_rosters(self):
        ...
        file_path = os.path.expanduser(f'/Users/sputnik69/Documents/_CODE/_pennant_race/league_files/league_rosters_{timestamp}.xlsx')
